                        ...
                        if hand2 == False: 
                            for i in idx_pose:
                                for k in range(2, 5):
                                    ...
                                    img[i[1], i[0] - 1: i[0]+ 1, 0] = 255
                                    img[i[1], i[0] - 1 : i[0] + 1, 1] = 255
                                    img[i[1], i[0] - 1 : i[0] + 1, 2] = 255
                                    
                                    img[i[1], i[0] + k : i[0]+ k+1, 0] = t
                                    img[i[1] , i[0] + k: i[0] + k+1, 1] = 0
                                    img[i[1], i[0] + k: i[0] + k+1, 2] = r
                            ...
                            for i in idx_pose:
                                for k in range(2, 5):
                                    ...
                                    mask[i[1], i[0] + k : i[0]+ k+1, 0] = t
                                    mask[i[1] , i[0] + k: i[0] + k+1, 1] = 0
                                    mask[i[1], i[0] + k: i[0] + k+1, 2] = r
